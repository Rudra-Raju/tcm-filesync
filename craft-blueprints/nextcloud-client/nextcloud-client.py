...
class subinfo(info.infoclass):
    ...
    def setTargets(self):
        # TCM override — point at our fork instead of upstream nextcloud/desktop
        self.svnTargets["master"] = "[git]https://github.com/rudrarajur6-alt/tcm-filesync"

        self.description = "The Cloud Market Sync Client"
        self.displayName = "The Cloud Market"
        self.webpage = "https://thecloud.market"
...
class Package(CMakePackageBase):
    ...
    def createPackage(self):
        ...
        self.defines["productname"] = "The Cloud Market"
